...
//   Gate 2 — regression test: the test Pi wrote must pass, and one must
...
// Gate 2: Pi must have written at least one regression test, and it must
...
// Run gates 2–4 after a fix. Gate 1 runs before the Pi session (see
