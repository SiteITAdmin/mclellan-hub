...
function buildTaskActionQualityReview({ tasks = [], intakes = [], answered = null } = {}) {
...
function runCrmQualityBoards(user = 'douglas') {
  ...
  const receipts = [
    ...
    writeCrmSectionQualityReceipt(user, 'crm:tasks', buildTaskActionQualityReview({ tasks, intakes, answered })).receipt,
