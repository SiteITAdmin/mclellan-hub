...
function writeTagsIndex({ projects, wikiTags }) {
  ...
  const lines = [
    '---',
    'title: Wiki Context Pins Index',
    'type: wiki-context-pins-index',
    `updated: '${new Date().toISOString().slice(0, 10)}'`,
    'tags: [wiki-context-pins]',
    '---',
    '',
    '# Wiki Context Pins Index',
    '',
    'Manual project-to-wiki pins. Contact relationships are derived by the Hub knowledge layer, not maintained here.',
    '',
    '## Projects',
  ];
