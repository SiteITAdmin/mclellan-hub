...
const FEATURE_RUNNERS = Object.freeze({
  ...
  // This is the ChatGPT Go/Codex lane. A full digest can exceed 125KB and the
  // resulting keep-all editorial briefing can exceed the generic 32KB cap.
  newsletter_digest_briefing: slot('luna', { effort: 'high', jsonMode: false, maxInputChars: 220000, maxOutputChars: 200000, timeoutMs: 900000 }),
