...
async function streamOpenRouter(modelId, messages, onChunk, options = {}) {
  ...
  // Tool leak: model output DSML/internal syntax instead of a real response — full is the raw
  // leak content that was suppressed from the stream; replace with a clean warning.
  if (toolLeakDetected) {
