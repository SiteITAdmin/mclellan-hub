...
const SUPPORTED_EXTS = [...NATIVE_EXTS, ...MARKITDOWN_EXTS, ...IMAGE_EXTS];
...
async function fileToMarkdown(filename, buffer) {
  ...
  if (IMAGE_EXTS.includes(ext)) return { markdown: `(image: ${filename})`, isImage: true };
...
module.exports = { fileToMarkdown, withProjectFrontmatter, SUPPORTED_EXTS, IMAGE_EXTS, fetchUrl };
