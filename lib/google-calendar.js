 ...
 * see upsertMeetingRow in lib/crm.js) so it shows up in the planner
 * without waiting for the next daily calendar sync. Planner-sourced
 * rows (`source='task_planner'`) stay off `/crm/meetings`.
 *
