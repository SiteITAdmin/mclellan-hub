...
const { recordProcessingFailure } = require('./processing-failures');
...
async function materializeMimePart(gmail, messageId, part) {
  ...
  if (mimeType === 'multipart/alternative') {
    ...
    const chosen = children.find(child => child.hasPlain && child.segments.length)
      || children.find(child => child.segments.length)
      || { segments: [], hasPlain: false, hasHtml: false, attachments: [] };
