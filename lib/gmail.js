...
async function fetchMessagesByLabelId(gmail, labelId, sinceTs, skipIds = new Set()) {
  ...
  return fetchReceivedMessages(gmail, listRes.data.messages || [], { skipIds, logPrefix: 'label-poll' });
}
