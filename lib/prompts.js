...
- Treat completed, deleted, and wrong task states as authoritative human decisions. Do not recreate or paraphrase those tasks unless the source contains a clearly new request or changed circumstance after that state change. A completed task is evidence of completion, never evidence that the same task is newly outstanding.
