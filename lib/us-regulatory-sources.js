...
const US_STATE_AG_NEWSROOMS = [
  ['Alabama Attorney General', 'https://alabamaag.gov/news-releases/'],
  ...
  ['Arkansas Attorney General', 'https://arkansasag.gov/news-releases/'],
  ...
  ['Delaware Department of Justice', 'https://news.delaware.gov/category/department-of-justice/'],
  ['Florida Attorney General', 'https://www.myfloridalegal.com/newsroom'],
  ['Georgia Department of Law', 'https://law.georgia.gov/press-releases'],
  ['Hawaii Department of the Attorney General', 'https://ag.hawaii.gov/ag-news/'],
  ...
  ['Louisiana Attorney General', 'https://ag.state.la.us/News'],
  ...
  ['Massachusetts Attorney General', 'https://www.mass.gov/lists/attorney-general-press-releases'],
  ['Michigan Attorney General', 'https://www.michigan.gov/ag/news/press-releases'],
  ['Minnesota Attorney General', 'https://www.ag.state.mn.us/Office/PressReleases/'],
  ...
  ['North Dakota Attorney General', 'https://attorneygeneral.nd.gov/news-releases/'],
  ...
  ['Oregon Department of Justice', 'https://www.doj.state.or.us/media/news-media-releases/oregon-doj-news/'],
  ...
  ['South Dakota Attorney General', 'https://atg.sd.gov/News/'],
  ...
  ['Vermont Attorney General', 'https://ago.vermont.gov/news'],
  ...
  ['District of Columbia Attorney General', 'https://oag.dc.gov/release'],
  ['West Virginia Attorney General', 'https://ago.wv.gov/pressroom/'],
  ['Wisconsin Department of Justice', 'https://www.doj.state.wi.us/news-releases'],
  ['Wyoming Attorney General', 'https://ag.wyo.gov/news'],
].map(([name, url]) => ({ name, url }));
