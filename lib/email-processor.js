...
Rules:
- Only set contact_name if the email is FROM a known contact (sender name or email address matches) OR the subject line is explicitly about them — a name appearing in the body alone is not enough
