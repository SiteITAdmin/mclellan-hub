...
async function processNewEmails(user) {
  ...
  // Gmail Promotions remain excluded from normal CRM classification, but are
  // appraised through a separate bounded lane. Only actionable candidates are
  // retained; only causally relevant candidates are atomised and emailed.
...
module.exports = { appraisePromotionEmails, classifyEmail, processNewEmails, processSentEmails };
