...
const SYSTEM_MODEL_GROUPS = [
  ...
  { id: 'newsletter', label: 'Newsletter intelligence', slots: [
    ...
    { feature: 'newsletter_digest_briefing', scope: 'system', label: 'Newsletter intelligence brief', note: "Rewrites Douglas's daily Douglas Newsletters digest into the house briefing style (sponsors/tracking stripped, PDF emailed).", fallback: 'anthropic/claude-sonnet-4-6' },
  ]},
